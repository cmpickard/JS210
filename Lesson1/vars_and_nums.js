...
// Declare a variable named answer and set it to the result of numerator divided
// by DENOMINATOR. Log the value of answer (it should be 5).
...
// this with the self-addition operator, +=, e.g., incrementer += 1. (All we did
//   was remove the second instance of incrementer, and then recombined the
...
// Set the value of end to incrementer and the value of difference to end
...
// Declare a variable named answer and initialize it to the result of 11
